...
interface ManagerFeedbackTableProps {
  feedbacks: ManagerFeedback[];
  loading: boolean;
  title?: string;
}

type SortField = 'from' | 'year' | 'quarter' | 'rating' | 'satisfaction';
type SortDirection = 'asc' | 'desc';

const ManagerFeedbackTable: React.FC<ManagerFeedbackTableProps> = ({
  feedbacks,
  loading,
  title: _title = 'Feedbacks Received as Manager',
}) => {
